...
class IRacingReader:
    ...
    including inputs, speed, lap progress, temperatures, wheel data, and fuel.
    """
    ...
    def get_telemetry(self) -> dict | None:
        ...
        last_lap_time, best_lap_time, steering_angle, yaw_rate, lat_accel,
        wheel_rpm_{lf,rf,lr,rr}, fuel_level, fuel_use_per_hour,
        ...
        return {
            ...
            # Lateral acceleration in m/s² (positive = left)
            "lat_accel":         self.ir["LatAccel"],
            # Individual wheel RPM (rad/s)
            "wheel_rpm_lf":      self.ir["LFwheelSpdRPM"],
            "wheel_rpm_rf":      self.ir["RFwheelSpdRPM"],
            "wheel_rpm_lr":      self.ir["LRwheelSpdRPM"],
            "wheel_rpm_rr":      self.ir["RRwheelSpdRPM"],
            # Fuel
